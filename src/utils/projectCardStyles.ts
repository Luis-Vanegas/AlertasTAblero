...
export const CARD_CLASSES = {
  ...
  shineGradient:
    'h-full w-full bg-gradient-to-r from-transparent via-white/10 to-transparent',
  content:
    'relative h-full flex flex-col items-center justify-center p-0.5 sm:p-1 md:p-2 lg:p-3 text-center flex-1 min-h-0 z-10',
  iconContainer:
    'flex-shrink-0 mb-0.5 sm:mb-0.5 md:mb-1 lg:mb-2',
  iconWrapper:
  ...
  iconSizes:
    'w-6 h-6 sm:w-7 sm:h-7 md:w-9 md:h-9 lg:w-11 lg:h-11 xl:w-12 xl:h-12',
  iconInnerSizes:
