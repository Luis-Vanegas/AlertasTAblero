...
const COLOR_CONFIG = {
  cyan: {
    ...
    gradientHover: 'group-hover:from-cyan-500/10 group-hover:via-cyan-500/20 group-hover:to-cyan-500/10',
  },
  blue: {
    ...
    gradientHover: 'group-hover:from-blue-500/10 group-hover:via-blue-500/20 group-hover:to-blue-500/10',
  },
} as const;
